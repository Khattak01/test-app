    ...
    return (
        <Box className={classes.banner}>
            ...
            <div className={classes.banner__bottom}>
                <div><h1>Financial times Logo</h1></div>
                <div><h1>Yahoo finance Logo</h1></div>
                <div><h1>Coindesk Logo</h1></div>
                <div><h1>Chain news Logo</h1></div>
                <div><h1>The block Logo</h1></div>
                <div><h1>Coin telegraph  Logo</h1></div>
            </div>
        </Box>
    )
}
